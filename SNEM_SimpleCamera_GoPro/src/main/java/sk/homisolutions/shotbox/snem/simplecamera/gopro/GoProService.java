...
public class GoProService implements Runnable{
    ...
    public void run() {
        try {
            ...
            takePicture();
            Object takenPhoto = getTakenPhoto();
    ...
    private void setupTakenPicture(Object pictureAsByteArray) {
        picture.setPicture(pictureAsByteArray);
        picture.setType(MimeTypes.JPG);
    }

    private Object getTakenPhoto() {
        Object photo;
...
//        throw new UnsupportedOperationException("Method is not implemented");
    ...
    private void checkResponseStatus(Response response) {
        if(response.getStatus() != Response.Status.OK.getStatusCode())
            throw new SNEM_ShootTrigger_GoPro_Exception("Response code is not 200, but: " +response.getStatus());
    }
}
